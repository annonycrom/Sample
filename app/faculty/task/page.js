...
export default function Section () {
  return (
    <div className="bg-white m-0 min-h-screen">
           <div className="flex flex-row items-start">
                ...
                <header className="flex-1 flex items-center justify-center">
                    <h1 className="bg-yellow-500 w-5/5 text-center text-4xl font-bold text-black p-10.5 py-20">Faculty Task</h1>
                </header>
            </div>
    ...
    <nav className="flex flex-col gap-11 bg-yellow-600  shadow-md max-w-max text-center">
                ...
                <a href="/faculty/task" className="text-lg font-bold bg-yellow-400 px-29 py-10" target="_self" >Task</a>
